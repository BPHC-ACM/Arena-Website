...
export function SquashForm({ match, onSave, isCreate }: any) {
  const [form, setForm] = useState(match ?? DEFAULTS['squash']);
  ...
  return (
    <div className='space-y-5'>
      ...
      <StatusSelect sport='squash' value={form.status ?? ''} onChange={handleStatusChange} />
